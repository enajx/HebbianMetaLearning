...
def main(argv):
    ...
    parser.add_argument('--generations', type=int, default= 200, metavar='', help='Number of generations that the ES will run.')
    ...
    parser.add_argument('--number_rules', type=int, default=128, metavar='', help='Number of rules, if 0 it uses one per synapse')
    ...
    es = EvolutionStrategyHebb(args.hebb_rule, args.environment, args.init_weights, population_size=args.popsize, sigma=args.sigma, learning_rate=args.lr, decay=args.decay, num_threads=args.threads, distribution=args.distribution, num_rules=args.number_rules)
