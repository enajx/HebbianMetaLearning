...
def main(argv):
    ...
    # parser.add_argument('--environment', type=str, default='CartPole-v0', metavar='', help='Environment: any OpenAI Gym or pyBullet environment may be used')
    ...
    # parser.add_argument('--environment', type=str, default='MountainCarContinuous-v0', metavar='', help='Environment: any OpenAI Gym or pyBullet environment may be used')
    parser.add_argument('--hebb_rule', type=str,  default = 'neuralHebb3withBias', metavar='', help='neuralHebb2, neuralHebb3, neuralHebb3withBias')
    parser.add_argument('--popsize', type=int,  default = 2, metavar='', help='Population size.') 
    ...
    parser.add_argument('--generations', type=int, default= 1, metavar='', help='Number of generations that the ES will run.')
