...
def main(argv):
    ...
    parser.add_argument('--popsize', type=int,  default = 10, metavar='', help='Population size.') 
    ...
    parser.add_argument('--generations', type=int, default= 10, metavar='', help='Number of generations that the ES will run.')
